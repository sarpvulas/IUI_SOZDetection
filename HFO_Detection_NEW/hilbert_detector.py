...
# Local imports
from HFO_Detection_NEW.util import check_detection_overlap
from HFO_Detection_NEW.method import Method


def detect_hfo_hilbert(sig, fs=None, low_fc=80, high_fc=120, threshold=3,
                       band_spacing='linear', num_bands=300,
                       cyc_th=6, gap_th=1, mp=6):
    """
